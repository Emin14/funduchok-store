...
export default function currentTime(points) {
    ...
    else if (wordBall.includes(points) || wordBall.includes(unitOfNumber)) {
      return 'балл'
    }
    else if (wordBalla.includes(points) || wordBalla.includes(unitOfNumber)) {
      return 'балла'
    }

    else if (wordBallov.includes(points) || wordBallov.includes(unitOfNumber)) {
      return 'баллов'
    }
    }
    else if (points > 99) {

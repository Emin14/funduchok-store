import { amountOfDiscount, weightAndkoef } from './constans';
...
// Функция для подсчета и сохранения в state:
// цены в зависимости от фасовки, скидочной цены, сумму скидки, сумму баллов
export function calcWeightProperties(weight, product) {
  ...
  const fasovka = productPacking.weight;
